...
myst_html_meta = {
    "description": "IP2WHOIS Deno SDK allows user to query  WHOIS lookup API that helps users to obtain domain information.",
    "keywords": "IP2WHOIS, Deno, WHOIS, domain",
...
# Favicon
html_favicon = 'images/ip2whois_favicon_32.png'
